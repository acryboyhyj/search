...
from sites.jobbole.es_jobbole import JobboleBlogIndex
...
def gen_suggests(index, info_tuple):
    ...
    for text, weight in info_tuple:
        if text:
            words = es.indices.analyze(index="jobbole_blog",body={'text':text,'analyzer':"ik_max_word",'filter':["lowercase"]})
...
class JobboleArticleItem(scrapy.Item):
    ...
    def save_to_es(self):
        ...
        article.suggest = gen_suggests(es, ((article.title,10),(article.tags, 7)))
        article.save()
